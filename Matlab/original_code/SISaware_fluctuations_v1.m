...
% beta = 0.6;    % 无意识的感染者感染无意识的易感者 / 原始感染率
...
epsilon = 2.5;    % epsilon*gama是I(+)恢复概率 / 康复加速因子

alpha = 0.3;    % 意识传播概率(较小的)/ 信息传播率
...
for times = 1 : 50    % times有其他用处，但是这里可以重新定义为计次数用变量
    times
